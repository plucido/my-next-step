    ...
    <div style={{position:"fixed",inset:0,zIndex:300,background:"rgba(0,0,0,0.3)",display:"flex",alignItems:"center",justifyContent:"center",padding:20}} onClick={onClose}>
      <div onClick={function(e){e.stopPropagation();}} style={{width:"100%",maxWidth:500,maxHeight:"85vh",overflowY:"auto",background:C.card,borderRadius:24,padding:28,boxShadow:C.shadowLg}}>
        ...
        {renderSection(
          ...
          "Journeys",
          "A journey is a multi-step plan with a timeline. Think trip itineraries, workout programs, or project plans. Each journey has tasks you can check off as you go.",
          null
        )}
        ...
        {renderSection(
          ...
          "Routines",
          "A routine is a recurring activity — weekly workouts, Saturday adventures, daily meditation. The AI generates fresh content for each occurrence and can add them to your calendar automatically.",
          null
        )}
        ...
        <div style={{marginBottom:24}}>
          ...
          <div style={{...F,fontSize:14,color:C.t2,lineHeight:1.6}}>
            Your AI guide lives in the Guide tab. Just tell it what you want — "plan a trip to Florence", "find a restaurant tonight", "build me a workout plan" — and it creates steps, journeys, or routines for you. It searches the web for real options with prices and booking links.
          </div>
        </div>
