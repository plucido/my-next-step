...
export default function App() {
  ...
  const resetAll = async () => { try { await window.storage.delete("mns-v9"); await window.storage.delete("mns-strava"); } catch {} setProfile(null); setMessages([]); setSteps([]); setPlans([]); setPreferences([]); setStravaData(null); setScreen("auth"); };
...
function loadGoogleScript() {
  return new Promise((resolve) => {
    ...
    s.id = "gsi-script"; s.src = "https://accounts.google.com/gsi/client"; s.onload = resolve;
